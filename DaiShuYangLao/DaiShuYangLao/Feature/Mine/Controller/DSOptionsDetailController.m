//
//  DSCompanyOpinionsController.m
//  DaiShuYangLao
//
//  Created by YueLiang Song on 2018/8/17.
...
@interface DSOptionsDetailController ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation DSOptionsDetailController
...
//        NSString * title = @[@"期权明细",@"支出明细",@"收入明细"][indexPath.row];
...
- (void)reqeustDataWithRefreshFlag:(DSRefreshFlag)refreshFlag{
    ...
    [DSHttpResponseData mineGetOptionsDetailwithParams:params callback:^(id info, BOOL succeed, id extraInfo) {
